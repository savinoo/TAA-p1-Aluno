...
export class CriaMatricula {
    ...
    async calcularColocacaoAluno(aluno: Aluno, disciplina: Disciplina): Promise<number[] | Error> {
        /* TODO:
        ...
        */
        ...
        if (matriculasDisciplina) {
            if (matriculasDisciplina.length > 0) {
        ...
        return new Error('Aluno não matriculado nessa disciplina');
